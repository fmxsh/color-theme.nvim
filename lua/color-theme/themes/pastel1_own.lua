local colors = {
	...
	-- Markup
	markup_strong = "#F6C177", -- Warm pastel orange for bold text
	markup_italic = "#CBA6F7", -- Gentle pastel lavender for italic text
	markup_strikethrough = "#FFA89F", -- Subtle pastel pink for strikethrough
	markup_underline = "#92E2D3", -- Vibrant pastel teal for underline

	markup_heading = "#CADCFA",
	markup_heading_1 = "#FF6666",
	markup_heading_2 = "#66FF66",
	markup_heading_3 = "#FFFF66",
	markup_heading_4 = "#BEEEE5",
	markup_heading_5 = "#CADCFA",
	markup_heading_6 = "#BEEEE5",

	--	original
	--	markup_heading = "#A6C5F7", -- Soft pastel blue for headings
	--	markup_heading_1 = "#FF0000",
	--	markup_heading_2 = "#00FF00",
	--	markup_heading_3 = "#FFFF00",
	--	markup_heading_4 = "#92E2D3",
	--	markup_heading_5 = "#A6C5F7",
	--	markup_heading_6 = "#92E2D3",
	markup_quote = "#5C7080", -- Dim pastel gray-blue for block quotes
	markup_math = "#F6C177", -- Warm pastel orange for math environments
	markup_link = "#92E2D3", -- Vibrant pastel teal for links
	markup_link_label = "#9FE6E0", -- Muted pastel aqua for link labels
	markup_link_url = "#87BDF1", -- Subdued pastel sky blue for URLs
	markup_raw = "#FF0000", -- Pale pastel gray-blue for raw text
	markup_raw_block = "#5C7080", -- Dim pastel gray-blue for raw blocks
	markup_list = "#A6C5F7", -- Soft pastel blue for lists
	markup_list_checked = "#B7E6A5", -- Light pastel green for checked list items
	markup_list_unchecked = "#FFA89F", -- Subtle pastel pink for unchecked list items
	markup_paragraph = "#d1b8b8", -- Subtle pastel pink for unchecked list items
